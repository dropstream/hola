...
namespace :github do
  task :create_pull_request_into_master do
    create_pull_request('master', 'development', "Release version #{Bump::Bump.current}")
    # be sure we have latest locally before building locally
    system('git pull origin')
  end

  task :create_pull_request_into_development do
    create_pull_request('development', 'master', "Merge Release #{Bump::Bump.current}")
  end
end
